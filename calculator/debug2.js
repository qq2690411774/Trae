...
function inputNumber(num) {
    ...
    console.log(`  hasUnclosedParens=${hasUnclosedParens}, open=${openCount}, close=${closeCount}`);
...
function inputOperator(op) {
    console.log(`inputOperator('${op}'): START currentInput='${currentInput}', previousInput='${previousInput}'`);
    ...
    console.log(`inputOperator('${op}'): END previousInput='${previousInput}', operator='${operator}', shouldResetDisplay=${shouldResetDisplay}`);
}
...
function calculate() {
    ...
    if (hasBalancedParens) {
        ...
        console.log(`  hasBalancedParens=true, evaluateExpression result=${result}`);
